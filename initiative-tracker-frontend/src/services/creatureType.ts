...
const creatureTypeApi = api.injectEndpoints({
    endpoints: builder => ({
        ...
        createCreatureType: builder.mutation<CreateCreatureTypeResponse, CreateCreatureTypeRequest>({
            query: request => ({
                url: `creatureType`,
                method: 'POST',
                body: request,
        ...
        deleteCreatureType: builder.mutation<DeleteCreatureTypeResponse, DeleteCreatureTypeRequest>({
            query: request => ({
...
export const {useGetCreatureTypesQuery, useCreateCreatureTypeMutation, useDeleteCreatureTypeMutation} = creatureTypeApi;

...
import { CreatureType, useGetCreatureTypesQuery } from '../../services/creatureType';
...
const CreatureTypeList = () => {
  ...
  const [selectedRow, setSelectedRow] = useState<CreatureType | undefined>(undefined);

  const { data: creatureTypes, isLoading } = useGetCreatureTypesQuery({});
  const { t } = useTranslation('translation', { keyPrefix: 'pages.creatureType' });
